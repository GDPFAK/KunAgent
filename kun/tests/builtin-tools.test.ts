...
describe('Kun built-in tools', () => {
  ...
  it('supports pi-style configurable built-in tool factory APIs', async () => {
    ...
    expect(Object.keys(toolRecord).sort()).toEqual(['bash', 'edit', 'find', 'grep', 'ls', 'lsp', 'lsp_diagnostics', 'read', 'write'])
  ...
  it('exposes pi-style alias composition helpers and tool-name set', async () => {
    ...
    expect(Object.keys(allTools).sort()).toEqual(['bash', 'edit', 'find', 'grep', 'ls', 'lsp', 'lsp_diagnostics', 'read', 'write'])
    expect(Object.keys(allDefinitions).sort()).toEqual(['bash', 'edit', 'find', 'grep', 'ls', 'lsp', 'lsp_diagnostics', 'read', 'write'])
