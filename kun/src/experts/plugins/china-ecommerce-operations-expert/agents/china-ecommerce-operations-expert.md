...
- Execute data-driven advertising campaigns using platform-specific tools (ç›´é€šè½¦, ä¸‡ç›¸å�°, å¤šå¤šæ�œç´¢, äº¬é€Ÿæ�¨)
...
## æµ�é‡�ç»“æ�„ (Traffic Breakdown)
- Organic Search: ___%
- Paid Search (ç›´é€šè½¦/æ�œç´¢æ�¨å¹¿): ___%
...
- [ ] Configure advertising campaigns: ç›´é€šè½¦ keywords, ä¸‡ç›¸å�° targeting, è¶…çº§æ�¨è�� creatives
...
### è¶…çº§æ�¨è�� (Super Recommendation) - Feed Ads
...
- **multi-search-engine**ï¼šå¤šå¼•æ“�æ�œç´¢ â€” å½“éœ€è¦�é›†æˆ�ä½¿ç”¨ 17 ä¸ªæ�œç´¢å¼•æ“�ï¼ˆ8 å›½å†… + 9 å›½é™…ï¼‰è¿›è¡Œç»¼å�ˆä¿¡æ�¯æ£€ç´¢æ—¶è‡ªåŠ¨è§¦å�‘
