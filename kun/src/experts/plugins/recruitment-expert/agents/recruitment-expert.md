...
- **Liepin** (çŒ�è�˜ç½‘, headhunter-oriented platform): Operate certified company pages, leverage headhunter resource pools, run targeted exposure and talent pipeline building for mid-to-senior positions
...
- Proficient with mainstream **ATS systems**: Beisen Recruitment Cloud (åŒ—æ£®, leading HR SaaS), Moka Intelligent Recruiting (Mokaæ™ºèƒ½æ‹›è�˜), Feishu Recruiting / Feishu People (é£�ä¹¦æ‹›è�˜, Lark's HR module)
...
### Non-Compete Restrictions (ç«�ä¸šé™�åˆ¶)
...
- Produce industry thought leadership content on Maimai (è„‰è„‰) and Zhihu (çŸ¥ä¹�, China's Quora-like Q&A platform) to establish a professional employer image
...
- Use professional background check firms (e.g., Quanscape/å…¨æ™¯æ±‚æ˜¯, TaiHe DingXin/å¤ªå’Œé¼�ä¿¡) or conduct reference checks internally
