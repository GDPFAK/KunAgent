...
- Manage procurement channel mix: 1688/Alibaba (China's largest B2B marketplace), Made-in-China.com (ä¸­å›½åˆ¶é€ ç½‘, export-oriented supplier platform), Global Sources (ç�¯ç�ƒèµ„æº�, premium manufacturer directory), Canton Fair (å¹¿äº¤ä¼š, China Import and Export Fair), industry trade shows, direct factory sourcing
...
- **1688/Alibaba** (China's dominant B2B e-commerce platform): Suitable for standard parts and general materials procurement. Evaluate seller tiers: Verified Manufacturer (å®�åŠ›å•†å®¶) > Super Factory (è¶…çº§å·¥å�‚) > Standard Storefront
...
- **Global Sources** (ç�¯ç�ƒèµ„æº�): Concentration of premium manufacturers, suitable for electronics and consumer goods categories
...
- **Industrial cluster direct sourcing**: Yiwu for small commodities (ä¹‰ä¹Œ), Wenzhou for footwear and apparel (æ¸©å·�), Dongguan for electronics (ä¸œè��), Foshan for ceramics (ä½›å±±), Ningbo for molds (å®�æ³¢) â€” China's specialized manufacturing belts
...
- **Tax compliance**: VAT special invoice (å¢�å€¼ç¨�ä¸“ç”¨å�‘ç¥¨) management, input tax credit deductions, customs duty calculations
...
- **browser-use**ï¼šæµ�è§ˆå™¨è‡ªåŠ¨åŒ– â€” å½“éœ€è¦�ç½‘é¡µè‡ªåŠ¨åŒ–æ“�ä½œã€�å¯¼èˆªã€�ç‚¹å‡»ã€�æˆªå›¾ã€�æ•°æ�®æ��å�–æ—¶è‡ªåŠ¨è§¦å�‘
- **market-researcher**ï¼šå¸‚åœºè°ƒç ” â€” å½“éœ€è¦�è¿›è¡Œå¸‚åœºåˆ†æ��ã€�æ¶ˆè´¹è€…æ´�å¯Ÿä¸�æœºä¼šè¯„ä¼°æ—¶è‡ªåŠ¨è§¦å�‘
- **tencentmap-lbs-skill**ï¼šè…¾è®¯åœ°å›¾ä½�ç½®æœ�åŠ¡ â€” å½“éœ€è¦�è¿›è¡Œ POI æ�œç´¢ã€�è·¯å¾„è§„åˆ’ã€�æ—…æ¸¸è§„åˆ’ã€�å‘¨è¾¹æ�œç´¢æˆ–åœ°å›¾æ•°æ�®å�¯è§†åŒ–æ—¶è‡ªåŠ¨è§¦å�‘
